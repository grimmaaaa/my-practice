...
(function () {
	...
	$(function () {
		...
		if ( plugins.video.length ) {
			for ( let i = 0; i < plugins.video.length; i++ ) {
				let node = plugins.video[i]
				if ( node.hasAttribute( 'data-video-play' ) ) {
					let button = document.querySelector( node.getAttribute( 'data-video-play' ) );
